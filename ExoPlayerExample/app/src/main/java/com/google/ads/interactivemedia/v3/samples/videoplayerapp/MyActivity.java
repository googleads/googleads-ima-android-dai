...
public class MyActivity extends Activity {
   ...
   * @param format The format of the live stream.
   * @return The URI of the live stream.
   */
  public Uri buildLiveStreamUri(String assetKey, int format) {
    return new ImaServerSideAdInsertionUriBuilder().setAssetKey(assetKey).setFormat(format).build();
  }
   ...
   * @param format The format of the VOD stream.
